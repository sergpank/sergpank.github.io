...
Эти же диски в формате HiMD можно было переформатировать в 305МБ - <https://en.m.wikipedia.org/wiki/MiniDisc#Hi-MD/>

Также на закате этого формата вышел HiMD диск, который вмещал 1ГБ данных, прилично даже на сегодняшний день.!
